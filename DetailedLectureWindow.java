...
public class DetailedLectureWindow extends JFrame {
    ...
    private void initComponents() {
        ...
        String[] detailHeaders = {
            "선택", "교과목명", "교과목코드", "담당교수", "강의시간", "강의실", "호실번호", "필수", "설계", "학점", "학년", "평점"
        };
        ...
        detailTable.getColumnModel().getColumn(1).setPreferredWidth(100); // 교과목명
        ...
        detailTable.getColumnModel().getColumn(11).setPreferredWidth(50);  // 평점
        detailTable.getColumnModel().getColumn(10).setPreferredWidth(50);  // 학년
     ...
     * 시간 겹침 검사
     */
    private boolean isTimeConflict(TimeSlot slot1, TimeSlot slot2) {
     ...
     * 기존 시간 형태 파싱
     */
    private List<TimeSlot> parseTraditionalTimeFormat(String lectureTime) {
        List<TimeSlot> timeSlots = new ArrayList<>();
     ...
     * 개별 시간 슬롯 파싱 (기존 로직)
     */
    private TimeSlot parseIndividualTimeSlot(String timeStr) {
        String[] patterns = {
